//Thu Aug 22 2024 15:13:37 GMT+0000 (Coordinated Universal Time)
...
class 哇哈哈_0xad71c {
  ...
  async taskinfo() {
    ...
    if (_0x27f698.code == "0000") {
      this.activeId = _0x27f698.data.activeId;
    }
  }
  async tasklist() {
    ...
    if (_0x2bb179.code == "0000") {
      ...
      if (_0x4ef556 != "请在规定时间段内抢任务") {
        ...
        if (_0x296327 <= _0x4ef556) {
          console.log(this.f + "抢阅读任务时间未到，等待" + _0xa8b480 / 1000 + "秒后开始疯狂抢任务...");
          await $.wait(_0xa8b480);
          await this.receivetask(_0x746121);
        }
      } else {
    ...
    if (_0x2b01a4.code == "0000" && _0x2b01a4.data.length >= 1) {
      for (let _0x13cf1f of _0x2b01a4.data) {
        ...
        if (_0x13cf1f.taskDetail.currentValue < _0x13cf1f.taskDetail.taskValue) {
          ...
          if (_0x13cf1f.taskDetail.currentValue == _0x13cf1f.taskDetail.taskValue) {
            console.log("【" + this.f + "】【" + _0x13cf1f.taskDetail.materialGroup.bindActiveName + "】任务已完成");
            await this.getreward(_0x13cf1f.taskDetail.materialGroup.bindActiveName, _0x13cf1f.id);
          }
        }
      }
    }
  ...
  async doread() {
    ...
    if (_0x31b56b.code == "0000") {
      console.log("【" + this.f + "】上传阅读时长成功");
  ...
  async getreward(_0x3cccdf, _0x1da0c7) {
    ...
    if (_0x1121cc.code == "0000") {
      console.log("【" + this.f + "】完成【" + _0x1121cc.data.taskDetail.taskName + "】任务，获得【" + _0x1121cc.data.exchangeResult.materialGroupInfo.groupName + "】奖励成功🎉🎉");
      this.message += "\n【" + this.f + "】完成【" + _0x1121cc.data.taskDetail.taskName + "】任务，获得【" + _0x1121cc.data.exchangeResult.materialGroupInfo.groupName + "】奖励成功🎉🎉";
    } else {
      console.log("【" + this.f + "】完成【" + _0x3cccdf + "】任务，结果:" + _0x1121cc.message);
    }
  }
  async lotterystatus() {
  ...
  async lottery() {
    ...
    if (_0xbb867d.code == "0000") {
      console.log("【" + this.f + "】完成阅读任务抽奖成功,获得:【" + _0xbb867d.data.prizedesc + "】奖励");
      this.message += "\n【" + this.f + "】完成阅读任务抽奖成功,获得:【" + _0xbb867d.data.prizedesc + "】奖励";
  ...
  async checkUserTakeActive() {
    ...
    if (_0x3e0f23.code == "0000") {
      if (_0x3e0f23.data > 0) {
        await this.dodraw();
      }
    } else {
      console.log("【" + this.f + "】暂无打卡抽奖机会,明天再来试试运气吧");
  ...
  async userinfo() {
    ...
    if (_0x12bbfd.code == "0000") {
      console.log("【" + this.f + "】已赚取:" + _0x12bbfd.data.totalNum / 100 + "元话费券，当前余额:" + _0x12bbfd.data.usableNum / 100 + "元话费券");
  ...
  return new class {
    ...
    task(_0x345124, _0x3f2fc8, _0x34f853, _0x5e8325, _0x4bb908) {
      ...
      if (_0x345124 == "post") {
        ...
        if (_0x5e8325) {
          _0x34f853["Content-Length"] = $.lengthInUtf8Bytes(_0x5e8325);
        }
      }
      if (_0x345124 == "get") {
        delete _0x34f853["content-type"];
        delete _0x34f853["Content-type"];
        delete _0x34f853["content-Type"];
        delete _0x34f853["Content-Length"];
      }
      ...
      return new Promise(async _0x19202f => {
        ...
        if (!_0x4bb908) {
          delete _0x48bde4.proxy;
        }
        this.request[_0x345124.toLowerCase()](_0x48bde4, (_0x2972b2, _0x16e1ed, _0x1763cc) => {
          try {
            if (_0x1763cc && LOGS == 1) {
              console.log("================ 请求 ================");
              console.log(_0x48bde4);
              console.log("================ 返回 ================");
              if ($.safeGet(_0x1763cc)) {
                console.log(JSON.parse(_0x1763cc));
              } else {
                console.log(_0x1763cc);
              }
            }
          } catch (_0x2cd9a7) {
            ...
            if (!_0x2972b2) {
              if ($.safeGet(_0x1763cc)) {
                ...
                if (_0x1763cc.indexOf("/") != -1 && _0x1763cc.indexOf("+") != -1) {
                  _0x38fa6d = _0x1763cc;
                } else {
                  _0x38fa6d = _0x1763cc;
                }
    ...
    timecs() {
      ...
      if (JSON.stringify(_0x5cb741).indexOf(" ") >= 0) {
        _0x5cb741 = _0x5cb741.replace(" ", "T");
      }
